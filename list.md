...
One idea per line. `- [ ]` = todo, `- [x]` = reel built.
The make-reel skill picks the first unchecked idea and marks it done after the mp4 renders.

# 180-Day Content Plan — The Connected Chain (Detailed)

**Format:** short-form video, 30–60 seconds, one idea per day
**Structure:** 30 arcs × 6 days. Every 6th video is a _bridge_ that hands off to the next topic.
**The chain:** Planets → Gravity → Earth → Atmosphere → Water → Ocean life → Evolution → Trees → Forests → Animal senses → Human body → Brain → Sleep → Food → Agriculture → Ancient engineering → Numbers → Money → Trade → Industry → Electricity → Light → Sound → Communication → Computers → AI → Robots → Rockets → Exploration → Cosmos → _loops back to Day 1_

Each entry gives you: the hook, what to cover, the angle that makes it different, a visual direction, and the closing line that pulls people to tomorrow.
...
- [x] **Day 6 — Why everything orbits on the same flat plane** _(bridge)_
      ...
      Visual: rotate the camera to edge-on so viewers _see_ the flatness, then dissolve into a spinning pizza dough.
      End on: "All of it held together by one thing we still barely understand. Tomorrow: gravity."
...
- [x] **Day 12 — You weigh less on a mountain** _(bridge)_
      ...
      Visual: a scale readout ticking down as the camera rises from sea level to summit to orbit.
      End on: "So what is under your feet? Tomorrow we dig."
...
- [x] **Day 18 — Your days are getting longer** _(bridge)_
      ...
      Visual: a clock face slowly stretching, with a timeline of day-length across geological eras.
      End on: "So the ground moves, the spin slows, the core burns. Tomorrow — look up."
...
- [x] **Day 24 — The ozone hole is healing** _(bridge)_
      ...
      Visual: year-by-year satellite ozone maps from 1980 to now.
      End on: "Almost all of this — clouds, storms, rain — is one substance doing the work. Tomorrow: water."
...
- [x] **Day 30 — Most of the ocean glows** _(bridge)_
      ...
      Visual: dark frame, long slow reveals — anglerfish, glowing plankton in a wave, a vampire squid.
      End on: "The creatures making that light are stranger than anything on land. That's the next week."
...
- [x] **Day 36 — The fish that crawled onto land** _(bridge)_
      ...
      Visual: fin-to-limb bone morphing animation, then overlaid on a human arm.
      End on: "That single move explains almost everything alive today. Tomorrow: how change actually works."
...
- [x] **Day 42 — Plants got here first** _(bridge)_
      ...
      Visual: bare rock terraforming into moss, then ferns, then the first forests, on a fast timeline.
      End on: "Then they got tall. Tomorrow: trees."
...
- [ ] **Day 48 — Seeds that trick animals into planting them** _(bridge)_
      ...
      Visual: quick-cut montage, one strategy per second, then the chilli reveal held longer.
      End on: "One tree is clever. A whole forest is a system. That's next."
...
- [ ] **Day 54 — The longest journey any animal makes** _(bridge)_
      ...
      Visual: migration routes drawn over a globe, then the tern's route overlaid on Earth-to-Moon distance.
      End on: "The answer is that they sense the world in ways we can't. That's next week."
...
- [ ] **Day 60 — Why humans lost their fur** _(bridge)_
      ...
      Visual: cooling comparison between a furred animal and a sweating human across a long chase.
      End on: "Which means the strangest machine in this whole series might be the one you're sitting in. Tomorrow: the human body."
...
- [ ] **Day 66 — Signals at 120 metres per second** _(bridge)_
      ...
      Visual: on-screen reaction-time test the viewer can try, then the reflex-arc diagram.
      End on: "Everything so far reports to one organ. Tomorrow we go into the brain."
...
- [ ] **Day 72 — Your brain washes itself while you sleep** _(bridge)_
      ...
      Visual: fluid flowing through widened channels between shrunken cells, sped up.
      End on: "Which raises the obvious question — what else happens in those 8 hours? That's next week."
...
- [ ] **Day 78 — Bad sleep makes you hungrier** _(bridge)_
      ...
      Visual: hormone level bars comparing a rested night against a restricted one.
      End on: "Which means the next question is what happens to food once you eat it. That's tomorrow."
...
- [ ] **Day 84 — How humans beat spoilage** _(bridge)_
      ...
      Visual: timeline of preservation methods with the population each one unlocked.
      End on: "Which is exactly what happened when we stopped chasing food and started growing it."
...
- [ ] **Day 90 — Spices were once worth more than gold** _(bridge)_
      ...
      Visual: spice routes on a period map with prices, then the voyages layered on top.
      End on: "But long before any of that, people were building things we still can't fully explain. That's next."
...
- [ ] **Day 96 — The first writing was a receipt** _(bridge)_
      ...
      Visual: token → impression → wedge script progression, with a real tablet translation.
      End on: "Which means the story of civilisation is really the story of numbers. That's next week."
...
- [ ] **Day 102 — A planet discovered with a pencil** _(bridge)_
      ...
      Visual: orbital deviation graph, predicted position, then telescope reveal.
      End on: "Numbers can find planets. They also decide what your work is worth. Next: money."
...
- [ ] **Day 108 — Money became data** _(bridge)_
      ...
      Visual: transaction volume growth chart, and a QR code at a street stall.
      End on: "Money moves instantly now. Physical goods still don't. Next week: how things actually get to you."
...
- [ ] **Day 114 — Then someone burned a rock** _(bridge)_
      ...
      Visual: energy-per-kilogram comparison, then a flooded mine shaft with a pump.
      End on: "That machine ended the age of muscle. Next week: industry."
...
- [ ] **Day 120 — Enough sunlight in one hour to power a year** _(bridge)_
      ...
      Visual: solar cost-per-watt curve, then a day/night generation-versus-demand mismatch graph.
      End on: "All of it produces the same thing, and almost nobody can define it. Tomorrow: what electricity actually is."
...
- [ ] **Day 126 — Light is electricity waving** _(bridge)_
      ...
      Visual: full spectrum bar with the visible slice marked as a hairline.
      End on: "That thin slice is doing more work than you'd believe. Next week: light."
...
- [ ] **Day 132 — How a camera freezes time** _(bridge)_
      ...
      Visual: the exposure triangle demonstrated with three example shots.
      End on: "Light is one kind of wave. The other one you can feel in your chest. Next: sound."
...
- [ ] **Day 138 — Capturing a voice forever** _(bridge)_
      ...
      Visual: groove close-up matching a waveform, then the same wave being digitised into points.
      End on: "Numbers can travel. Next week: how we send them across the planet."
...
- [ ] **Day 144 — Why nobody can read your messages** _(bridge)_
      ...
      Visual: paint-mixing key exchange, then a factoring-difficulty curve.
      End on: "All of this rests on machines that only understand two symbols. Next week: computers."
...
- [ ] **Day 150 — Computers that work in probabilities** _(bridge)_
      ...
      Visual: a classical search checking options one by one against a quantum approach, then a dilution refrigerator.
      End on: "Meanwhile, ordinary computers learned to do something nobody programmed them to do. Next week: AI."
...
- [ ] **Day 156 — Passing exams is easy. Folding laundry is hard.** _(bridge)_
      ...
      Visual: benchmark scores on exams next to failure footage on simple physical tasks.
      End on: "Which means the next frontier isn't software. It's bodies. Next week: robots."
...
- [ ] **Day 162 — Robots go where we can't** _(bridge)_
      ...
      Visual: control-delay comparison chart across environments.
      End on: "To get a robot to Mars, you first need to beat gravity. Next week: rockets."
...
- [ ] **Day 168 — We've littered orbit** _(bridge)_
      ...
      Visual: tracked debris cloud around Earth, then a hypervelocity impact test.
      End on: "Despite all that, we've sent things further than most people realise. Next week: exploration."
...
- [ ] **Day 174 — A telescope that sees 13 billion years back** _(bridge)_
      ...
      Visual: Hubble versus JWST on the same field, then a redshift stretching diagram.
      End on: "Which brings us to the biggest subject there is. Final week: the universe."
...
- [ ] **Day 180 — How a solar system is born** _(loop)_
      ...
      Visual: protoplanetary disc images from ALMA showing real gaps carved by forming planets.
      End on: "Which is exactly where this series started, 180 days ago. Planets. Start again from Day 1 — it reads completely differently the second time."
